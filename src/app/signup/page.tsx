  ...
  return (
    <div className="h-screen flex items-center justify-center m-auto w-full  text-white">
      <div className="mx-8 w-[30%] my-6 p-10 mb-8 flex flex-col relative bg-white/15">
        <h2 className="capital text-3xl font-semibold text-center mb-5">SIGNUP</h2>
        <div className="mx-auto flex w-full flex-col px-4 gap-y-2">
          <label htmlFor="username" className={` inline-block text-gray-300`}>
          ...
          >
            {loading ? <span>Processing...</span> : "Sign in"}
          </button>
          {error && <h2>Error</h2>}
          <h6 className="mx-auto text-md mb-3 mt-1">
            Already an Account?{" "}
            <Link href="/login" className="font-semibold text-blue-600 hover:text-blue-400">
              Login now
            </Link>
          </h6>
        </div>
